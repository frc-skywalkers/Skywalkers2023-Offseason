...
public class Lightstrip extends SubsystemBase {
  ...
  public void periodic() {
    ...
    if(currentColor != null) {
      SmartDashboard.putNumberArray("Current Led", currentColor.getState());
    }

    if(tempColor != null) {
      SmartDashboard.putNumberArray("Temp Led", tempColor.getState());
    }
  }
  ...
  private void setColor(int red, int green, int blue) {
    StrobeAnimation animation = new StrobeAnimation(red, green, blue, 0, 1, lightstripConstants.ledCount + 8);

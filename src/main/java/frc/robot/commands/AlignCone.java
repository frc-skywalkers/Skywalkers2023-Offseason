...
public class AlignCone extends CommandBase {
  ...
  public AlignCone(Swerve swerveSubsystem, Limelight camera, double targetXDist, double targetYDist, double targetR) { //meters, meters, degrees
  ...
  public void execute() {
    ...
    swerveSubsystem.drive(new Translation2d(xspeed, yspeed), 0, false, true); //xspeed is forward? yspeed is sideways, rspeed is rotational?

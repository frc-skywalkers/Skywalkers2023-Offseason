...
public class TurnAngle extends CommandBase {
  ...
  public TurnAngle(Swerve swerveSubsystem, double targetR) { //meters, meters, degrees
  ...
  @Override
  public void execute() {
    currentR = swerveSubsystem.getYawDouble(); //
    ...
    swerveSubsystem.drive(new Translation2d(0, 0), rspeed, false, true);
  }
